                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div>
                                ...
                                <div class="ibox-content profile-content">
                                    ...
                                    <p>
                                        <s:if test="<%= userVo.getEmailAddress() != null%>">
                                            <%= userVo.getEmailAddress() %>
                                        </s:if>
                                        <s:if test='<%= userVo.getEmailAddress() == null || userVo.getEmailAddress() ==""%>'>
                                            <button class="btn btn-primary block full-width m-b">绑定邮箱</button>
                                        </s:if>
                                    </p>
