        ...
        <ul class="nav" id="side-menu">
            <li class="nav-header">
                ...
                <div class="dropdown profile-element">
                    <span><img alt="image" class="img-circle" src="../../pages/img/profile_small.jpg"/></span>
            ...
            <c:forEach items="${menuList}" var="menu">
                <li>
                    <a href="${menu.menuUrl}"><i class="fa ${menu.menuClass}"></i><span class="nav-label">${menu.menuName}</span></a>
            ...
            <%--<li>--%>
                <%--<a href="/Welcome/init"><i class="fa fa-th-large"></i> <span class="nav-label">主页</span><span--%>
            ...
            <%--</li>--%>
            <%--<li>--%>
                <%--<a href="layouts.html"><i class="fa fa-columns"></i> <span class="nav-label">布局</span><span--%>
                        <%--class="label label-danger pull-right">2.0</span></a>--%>
            <%--</li>--%>
            <%--<li>--%>
                <%--<a href="index.html#"><i class="fa fa fa-globe"></i> <span class="nav-label">v2.0新增</span><span--%>
                        <%--class="fa arrow"></span></a>--%>
                <%--<ul class="nav nav-second-level">--%>
            ...
            <%--</li>--%>
            <%--<li>--%>
                <%--<a href="index.html#"><i class="fa fa-edit"></i> <span class="nav-label">表单</span><span--%>
                        <%--class="fa arrow"></span></a>--%>
                <%--<ul class="nav nav-second-level">--%>
            ...
            <%--</li>--%>
            <%--<li>--%>
                <%--<a href="index.html#"><i class="fa fa-files-o"></i> <span class="nav-label">其他页面</span><span--%>
                        <%--class="fa arrow"></span></a>--%>
                <%--<ul class="nav nav-second-level">--%>
            ...
            <%--<li class="active">--%>
                <%--<a href="index.html#"><i class="fa fa-flask"></i> <span class="nav-label">UI元素</span><span--%>
                        <%--class="fa arrow"></span></a>--%>
                <%--<ul class="nav nav-second-level">--%>
                    ...
                    <%--</li>--%>
                    <%--<li class="active"><a href="tree_view.html">树形视图</a>--%>
                    <%--</li>--%>
                <%--</ul>--%>
            <%--</li>--%>
            <%--<li>--%>
            ...
            <%--</li>--%>
            <%--<li>--%>
                <%--<a href="index.html#"><i class="fa fa-table"></i> <span class="nav-label">表格</span><span--%>
                        <%--class="fa arrow"></span></a>--%>
                <%--<ul class="nav nav-second-level">--%>
            ...
            <%--</li>--%>
            <%--<li>--%>
                <%--<a href="index.html#"><i class="fa fa-picture-o"></i> <span class="nav-label">图库</span><span--%>
                        <%--class="fa arrow"></span></a>--%>
                <%--<ul class="nav nav-second-level">--%>
            ...
            <%--</li>--%>
            <%--<li>--%>
                <%--<a href="index.html#"><i class="fa fa-sitemap"></i> <span class="nav-label">菜单 </span><span--%>
                        <%--class="fa arrow"></span></a>--%>
                <%--<ul class="nav nav-second-level">--%>
                    <%--<li>--%>
            ...
            <%--</li>--%>
            <%--<li>--%>
                <%--<a href="webim.html"><i class="fa fa-comments"></i> <span class="nav-label">即时通讯</span><span--%>
